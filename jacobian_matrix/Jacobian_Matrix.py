...
class Jacobian(FowardKinematics):
    ...
    def __column1(self):
        ...
        return self.T_0b[0:3, 0:3]* z_11
         
    
    def __column2(self):
        z_22 = Matrix([self.axis_rotation_J2[0], self.axis_rotation_J2[1], self.axis_rotation_J2[2]])
        z_22 = z_22.subs({self._theta[1]: 1})
        return self.T_0b[0:3, 0:3]* self.RotMatrix_funcOfTheta1[0:3, 0:3] * z_22

    def __column3(self):
        z_33 = Matrix([self.axis_rotation_J3[0], self.axis_rotation_J3[1], self.axis_rotation_J3[2]])
        z_33 = z_33.subs({self._theta[2]: 1})
        return self.T_0b[0:3, 0:3]* self.RotMatrix_funcOfTheta1[0:3, 0:3] * self.RotMatrix_funcOfTheta2[0:3, 0:3] * z_33

    def __column4(self):
        z_44 = Matrix([self.axis_rotation_J4[0], self.axis_rotation_J4[1], self.axis_rotation_J4[2]])
        z_44 = z_44.subs({self._theta[3]: 1})
        return self.T_0b[0:3, 0:3]* self.RotMatrix_funcOfTheta1[0:3, 0:3] * self.RotMatrix_funcOfTheta2[0:3, 0:3] * self.RotMatrix_funcOfTheta3[0:3, 0:3] * z_44

    def __column5(self):
        z_55 = Matrix([self.axis_rotation_J5[0], self.axis_rotation_J5[1], self.axis_rotation_J5[2]])
        z_55 = z_55.subs({self._theta[4]: 1})
        return self.T_0b[0:3, 0:3]* self.RotMatrix_funcOfTheta1[0:3, 0:3] * self.RotMatrix_funcOfTheta2[0:3, 0:3] * self.RotMatrix_funcOfTheta3[0:3, 0:3] * self.RotMatrix_funcOfTheta4[0:3, 0:3] * z_55

    def __column6(self):
        z_66 = Matrix([self.axis_rotation_J6[0], self.axis_rotation_J6[1], self.axis_rotation_J6[2]])
        z_66 = z_66.subs({self._theta[5]: 1})
        return self.T_0b[0:3, 0:3]* self.RotMatrix_funcOfTheta1[0:3, 0:3] * self.RotMatrix_funcOfTheta2[0:3, 0:3] * self.RotMatrix_funcOfTheta3[0:3, 0:3] * self.RotMatrix_funcOfTheta4[0:3, 0:3] * self.RotMatrix_funcOfTheta5[0:3, 0:3] * z_66
...
if __name__ == '__main__':
    ...
    Jc.setPos_World_Base(0, 0, 0,       1.5708, 0, 0)
    Jc.setPos_Base_J1(0, 0.1452, 0,     0, 0, 0)
    Jc.setPos_J1_J2(0, 0, 0.146,        0, 0, 0)
    Jc.setPos_J2_J3(0, 0.429, -0.1297,  0, 0, 0)
    Jc.setPos_J3_J4(0, 0.4115, 0.106,   0, 0, 0)
    Jc.setPos_J4_J5(0, 0.106, 0,        0, 0, 0)
    Jc.setPos_J5_J6(0, 0, 0.11315,      0, 0, 0)
